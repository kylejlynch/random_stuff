...
def plot_pareto(front, output_file: Path) -> None:
    try:
...
def run(
    ...
    frame = load_training_view(
        spark, sample_fraction=sample_fraction, random_state=split_seed
    )
    ...
    plot_pareto(best_front_sorted, output_dir / "pareto_front.png")
